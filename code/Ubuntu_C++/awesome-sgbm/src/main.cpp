...
int main(int argv, char** argc)
{
  if(argv < 3)
   ...
   cv::imwrite("/home/zty/python_program/awesome-sgbm/Data/FPGA_proc/grey_left.png", img_left);
   cv::imwrite("/home/zty/python_program/awesome-sgbm/Data/FPGA_proc/grey_right.png", img_right);
